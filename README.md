...
| Mode | Key             | Action                                                                                      |
|------|-----------------|---------------------------------------------------------------------------------------------|
| `n`  | `<leader>cd`    | Open file explorer (snacks.explorer)                                                       |
...
## Snacks Keybinds (Telescope replacement)

| Mode | Key             | Action                                                                                      |
|------|-----------------|---------------------------------------------------------------------------------------------|
| `n`  | `<leader>ff`    | Find files                                                                                  |
| `n`  | `<leader>fg`    | Ripgrep (live grep)                                                                        |
| `n`  | `<leader>fo`    | Open recent files                                                                           |
| `n`  | `<leader>fq`    | Open quickfix list                                                                          |
| `n`  | `<leader>fh`    | Open help tags                                                                              |
| `n`  | `<leader>fm`    | Open man pages                                                                              |
...
| `n`  | `<leader>fe`    | Open file explorer                                                                          |
| `n`  | `<leader>fr`    | Reveal current file in the file explorer                                                    |
| `n`  | `<leader>i`     | Preview the image at the cursor (e.g. in Markdown)                                          |
