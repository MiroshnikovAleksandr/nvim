-- KEYBINDS
vim.g.mapleader = " "
vim.keymap.set("n", "<leader>cd", function() Snacks.explorer() end, { desc = "File explorer" })
...
vim.keymap.set("n", "<leader>h", "<C-w>h")            -- focus pane left
vim.keymap.set("n", "<leader>j", "<C-w>j")            -- focus pane below
vim.keymap.set("n", "<leader>k", "<C-w>k")            -- focus pane above
vim.keymap.set("n", "<leader>l", "<C-w>l")            -- focus pane right
...
vim.keymap.set("n", "<leader>L", ":checkhealth vim.lsp<CR>", { desc = "LSP Info" })
